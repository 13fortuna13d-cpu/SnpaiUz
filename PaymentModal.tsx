      ...
      <div className="relative w-full max-w-2xl bg-slate-900 border border-amber-500/30 rounded-3xl p-5 sm:p-7 space-y-5 shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar my-auto">
        ...
        {success ? (
          <div className="py-8 text-center space-y-3">
            ...
            <h3 className="text-xl font-bold text-white">{t('vip.activated_success')}</h3>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-300 bg-slate-950/60 p-3.5 sm:p-4 rounded-2xl border border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <span>{t('vip.benefit_all_episodes')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-amber-400 shrink-0" />
                <span>{t('vip.benefit_no_ads')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-amber-400 shrink-0" />
                <span>{t('vip.benefit_hd')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-amber-400 shrink-0" />
                <span>{t('vip.benefit_dub')}</span>
              </div>
            </div>
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                ...
                >
                  <span>Click.uz</span>
                  <span className="text-[10px] text-blue-400">{t('vip.method_uzbekistan')}</span>
                </button>
                ...
                >
                  <span>Payme</span>
                  <span className="text-[10px] text-cyan-400">{t('vip.method_uzbekistan')}</span>
                </button>
                ...
                >
                  <span>Visa / Card</span>
                  <span className="text-[10px] text-purple-400">{t('vip.method_international')}</span>
                </button>
                ...
                >
                  <span>PayPal</span>
                  <span className="text-[10px] text-indigo-400">{t('vip.method_global')}</span>
                </button>
              </div>
            </div>
