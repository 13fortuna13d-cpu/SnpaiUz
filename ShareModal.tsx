...
export const ShareModal: React.FC<ShareModalProps> = ({ title, url = window.location.href, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-sm bg-slate-900 border border-slate-800 rounded-3xl p-6 text-center space-y-5 shadow-2xl max-h-[90vh] overflow-y-auto my-auto">
