...
export const Header: React.FC<HeaderProps> = ({
  ...
  // Lock background scroll while the full-screen search modal is open
  useEffect(() => {
  ...
  return (
    <header 
      className="fixed top-0 left-0 right-0 w-full z-40 bg-slate-950/95 backdrop-blur-md border-b border-purple-900/30 text-white shadow-lg shadow-purple-950/20 transition-all duration-200 will-change-transform"
    ...
    >
      ...
      {isSearchModalOpen && (
        <div className="fixed inset-0 z-50 bg-slate-950/95 backdrop-blur-2xl flex flex-col p-4 sm:p-6 animate-in fade-in overflow-y-auto">
