...
export const MangaReaderPage: React.FC<MangaReaderPageProps> = ({
  ...
  // Lock background scroll while the chapters list modal is open
  useEffect(() => {
  ...
  if (!manga || !chapter) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-4 text-center">
        <p className="text-slate-400 font-bold">{t('reader.not_found')}</p>
        <button
          ...
          <div className={`border-t px-4 py-3 text-xs space-y-3 animate-fadeIn ${
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <div className="space-y-1">
                <span className="font-bold text-[10px] uppercase opacity-70">{t('reader.reading_mode')}</span>
              ...
              {/* Theme Toggle */}
              <div className="space-y-1">
                <span className="font-bold text-[10px] uppercase opacity-70">{t('reader.background_color')}</span>
                <div className="flex rounded-xl overflow-hidden border border-purple-500/30">
                  <button
              ...
              {readingMode === 'vertical' && (
                <div className="space-y-1">
                  <span className="font-bold text-[10px] uppercase opacity-70">{t('reader.auto_scroll')}</span>
                  <button
          ...
          <div className="fixed inset-0 z-[100] bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-5 space-y-4 max-h-[80vh] flex flex-col">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                <h3 className="font-bold text-white text-sm">{t('reader.all_chapters_list')}</h3>
      ...
      <main ref={containerRef} className="max-w-4xl mx-auto py-6 px-2 min-h-[80vh] flex flex-col items-center">
        ...
        {!isUnlocked ? (
          ...
          <div className="my-12 p-8 max-w-lg w-full bg-slate-900/90 border border-amber-500/40 rounded-3xl text-center space-y-6 shadow-2xl backdrop-blur-xl">
            ...
            <div>
              <h2 className="text-xl font-extrabold text-white">{t('reader.chapter_locked')}</h2>
