...
export const TelegramBanner: React.FC = () => {
  ...
  return (
    <div className="telegram-banner max-w-7xl mx-auto px-4 my-6">
      <div className="relative overflow-hidden rounded-3xl p-5 sm:p-6 transition-all duration-300 border border-sky-500/40 bg-gradient-to-r from-sky-950/80 via-purple-950/60 to-slate-900 shadow-xl shadow-sky-950/20">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-0.5 rounded-full bg-sky-500/20 text-sky-300 font-extrabold text-[10px] uppercase tracking-wider border border-sky-500/30">
                  Rasmiy Telegram
                </span>
          ...
          <div className="w-full sm:w-auto shrink-0 flex items-center gap-3">
            ...
            >
              ...
              <span>{t('telegram.join_channel')}</span>
