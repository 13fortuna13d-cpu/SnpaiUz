...
export const FavoritesPage: React.FC<FavoritesPageProps> = ({ onNavigate, onOpenAuth }) => {
  ...
  if (!user) {
    return (
      <div className="py-20 text-center space-y-4 max-w-md mx-auto bg-slate-900/60 p-8 rounded-3xl border border-slate-800">
        ...
        <h2 className="text-xl font-bold text-white">Sevimlilaringizni ko'rish uchun kiring</h2>
  ...
  return (
    <div className="space-y-8">
      <SeoHead title="Sevimlilar Ro'yxati (SenpaiUz)" description="Saqlangan sevimli animelaringiz to'plami." />
