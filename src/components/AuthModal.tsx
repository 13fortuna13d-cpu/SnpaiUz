...
export const AuthModal: React.FC<AuthModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
      <div className="relative w-full max-w-md bg-slate-900 border border-purple-900/40 rounded-3xl p-6 sm:p-8 space-y-5 shadow-2xl">
        ...
        <div className="text-center space-y-1.5">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-600/20 border border-purple-500/40 text-purple-300 font-bold text-[11px] uppercase tracking-wider">
            ...
            <span>SenpaiUz Autentifikatsiya</span>
          </div>
            ...
            {regStep === 1 && (
              <form onSubmit={handleRegisterSendOtp} className="space-y-4">
                {type === 'phone' ? (
                  ...
                  <div>
                    <label className="block text-xs font-medium text-slate-400 mb-1">Email Manzili</label>
                    <div className="relative">
            ...
            {regStep === 2 && (
              <form onSubmit={handleRegisterVerifyOtp} className="space-y-4 text-center">
                ...
                <div className="space-y-1">
                  <h3 className="font-bold text-white text-sm">6 Xonali SMS Kodini Kiriting</h3>
                ...
                <div className="text-[11px] text-slate-400">
                  {timer > 0 ? (
                    <span>Qayta yuborish: <strong className="text-white">{timer}s</strong></span>
                  ) : (
                    <button
                      type="button"
                      onClick={() => {
              ...
              <form onSubmit={handleRegisterComplete} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1.5 flex items-center justify-between">
                    <span>Profil Rasmi (Avatar) <span className="text-red-400">* Majburiy</span></span>
                  </label>
                  <input
                    type="file"
                    ref={avatarInputRef}
                  ...
                  >
                    ...
                    <div className="text-xs">
                      {regAvatar ? (
                        <span className="text-purple-300 font-bold hover:underline">Rasmni almashtirish</span>
                      ) : (
                        <div className="space-y-0.5">
                          <p className="text-white font-semibold">Galereyadan rasm tanlang</p>
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-400 mb-1">Foydalanuvchi Nomi (Ism)</label>
                  <div className="relative">
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-400 mb-1">Parol Yaratish</label>
                  <div className="relative">
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-400 mb-1">Parolni Tasdiqlash</label>
                  <div className="relative">
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={type === 'phone' ? '+998 90 123 45 67' : 'admin@snpaiuz.uz'}
                  className="w-full bg-slate-950 border border-slate-800 rounded-2xl pl-10 pr-4 py-2.5 text-xs text-white"
                />
              </div>
            </div>
            ...
            {loginMethod === 'otp' && loginOtpStep === 2 && (
              <div className="space-y-2 text-center">
                <p className="text-xs text-slate-400 mb-2">Telefoningizga yuborilgan 6 xonali SMS tasdiqlash kodini kiriting:</p>
                <input
                  type="text"
                  maxLength={6}
                  required
