...
export const TopUpModal: React.FC<TopUpModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
      <div className="relative w-full max-w-lg bg-slate-900 border border-purple-900/40 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl">
        ...
        {!isSuccess ? (
          <>
            ...
            <div className="text-center space-y-2">
              ...
              <h2 className="text-2xl font-black text-white">Hisobni To'ldirish</h2>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 block">To'lov Tizimi:</label>
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  ...
                  <span className="text-[10px] text-cyan-400">Instant UZS</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] text-teal-400">Payme GO</span>
                </button>
                ...
                >
                  ...
                  <span className="font-bold text-[11px]">Uzcard / Humo</span>
                </button>
              </div>
            </div>
            ...
            {/* Amount Selection */}
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 block">Summani Tanlang:</label>
            ...
            <div className="p-3 bg-slate-950/60 rounded-2xl border border-slate-800 text-[11px] text-slate-400 flex items-center gap-2">
              ...
              <span>256-bit SSL xavfsiz to'lov va zudlik bilan balansga o'tkazish.</span>
            </div>
          ...
          <div className="py-8 text-center space-y-4">
            ...
            <h3 className="text-2xl font-black text-white">To'lov Muvaffaqiyatli!</h3>
